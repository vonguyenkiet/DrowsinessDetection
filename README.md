...
- **Kiến trúc Đa Luồng (Multi-threading):** Tách biệt I/O (Camera, Âm thanh, UI) và AI (MediaPipe) thành 4 luồng song song, sử dụng `queue.Queue` với chiến lược _"Drop old, keep new"_ nhằm triệt tiêu độ trễ (latency <= 2 giây), tối ưu FPS.
