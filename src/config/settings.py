...
EAR_THRESHOLD = 0.269      # Ngưỡng nhắm mắt (dưới giá trị này là nhắm mắt)
MAR_THRESHOLD = 0.011       # Ngưỡng ngáp (trên giá trị này là ngáp)

# --- HEAD POSE THRESHOLDS (Distraction) ---
# Cảnh báo khi Yaw (quay trái/phải) hoặc Pitch (cúi/ngẩng) vượt ngưỡng
PITCH_THRESHOLD = 155.8    # Độ
YAW_THRESHOLD = 1.2      # Độ
